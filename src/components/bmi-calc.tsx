...
export default function BmiCalculator() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen bg-cover bg-center bg-fixed bg-[url('/image/background.jpg')] dark:bg-[url('/image/background.jpg')]"
    >
      <Card className="w-full max-w-md mx-4 sm:mx-auto bg-white/80 dark:bg-gray-800/80 shadow-lg rounded-lg">
        <CardHeader>
